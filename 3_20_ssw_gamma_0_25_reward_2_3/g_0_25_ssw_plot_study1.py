...
def load_reward(prefix, start, inv, res_row_size, f_name, rewad_ylim_max, rewad_ylim_max_total,  data_type):
	...
	#rewad_ylim_max = 4;
	figure_name = f_name+prefix +str(0)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(ebuse)+'.jpg'
	plot_error(figure_name, time_data[0::inv], recv1_avg[0::inv], recv2, recv3, recv1_std[0::inv], 1, data_type, rewad_ylim_max)

	figure_name = f_name+prefix +str(1)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(ebuse)+'.jpg'
	...
	figure_name = f_name+prefix +str(2)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(ebuse)+'.jpg'
	plot_error(figure_name, time_data[0::inv], recv3_avg[0::inv], recv2, recv3, recv3_std[0::inv], 1, data_type, rewad_ylim_max)

	figure_name = f_name+prefix +str(3)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(ebuse)+'.jpg'
	plot_error(figure_name, time_data[0::inv], recv4_avg[0::inv], recv2, recv3, recv4_std[0::inv], 1, data_type, rewad_ylim_max)

	figure_name = f_name+'total_'+prefix +str(3)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(ebuse)+'.jpg'
	...
	plot_error_sub(plt, 221, figure_name, time_data[0::inv], recv1_avg[0::inv], recv2, recv3, recv1_std[0::inv], 1, data_type, rewad_ylim_max)

	#plot_error(figure_name, time_data[0::inv], recv2_avg[0::inv], recv2, recv3, recv2_std[0::inv], 1, 2)
	plot_error_sub(plt, 222, figure_name, time_data[0::inv], recv2_avg[0::inv], recv2, recv3, recv2_std[0::inv], 1, data_type, rewad_ylim_max)

	plot_error_sub(plt, 223, figure_name, time_data[0::inv], recv3_avg[0::inv], recv2, recv3, recv3_std[0::inv], 1, data_type, rewad_ylim_max)

	plot_error_sub(plt, 224, figure_name, time_data[0::inv], recv4_avg[0::inv], recv2, recv3, recv4_std[0::inv], 1, data_type, rewad_ylim_max)
...
plot_error_sub(plt, 221, figure_name, time_data[0::100], recv1_avg[0::100], recv2, recv3, recv1_std[0::100], 1, 1, over_ylim_max)

plot_error_sub(plt, 222, figure_name, time_data[0::100], recv2_avg[0::100], recv2, recv3, recv2_std[0::100], 1, 1, over_ylim_max)


plot_error_sub(plt, 223, figure_name, time_data[0::100], recv3_avg[0::100], recv2, recv3, recv3_std[0::100], 1, 1, over_ylim_max)

plot_error_sub(plt, 224, figure_name, time_data[0::100], recv4_avg[0::100], recv3, recv4, recv4_std[0::100], 1, 1, over_ylim_max)
...
f_name = 'figure/traffic_instant_'
start = 51
res_row_size=3590
rewad_ylim_max = 0.03
inv = 1
