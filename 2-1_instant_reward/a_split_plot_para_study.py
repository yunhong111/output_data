...
for i in range(0,dim):
	...
	recv_inst1, recv_inst2 = read_csv_data(file_name, 19, 21)
	
	file_name = prefix+str(1)+count_str+str(i)+postfix
	recv3, recv4 = read_csv_data(file_name, 23, 25)
	recv_inst3, recv_inst4 = read_csv_data(file_name, 19, 21)
...
plot_error(figure_name, time_data[0::inv_out], recv1_avg[0::inv_out], recv2, recv3, recv1_std[0::inv_out], 1, 1)

figure_name = 'figure/std_'+prefix +str(1)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(0.8)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv_out], recv2_avg[0::inv_out], recv2, recv3, recv2_std[0::inv_out], 1, 1)


figure_name = 'figure/std_'+prefix +str(2)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(0.8)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv_out], recv3_avg[0::inv_out], recv2, recv3, recv3_std[0::inv_out], 1, 1)

# plot instant traffic

figure_name = 'figure/std_inst_'+prefix +str(0)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(0.8)+ebuse_str+str(0.2)+'.jpg'
#plot_error(figure_name, time_data[0::inv_out], recv_inst1[0::inv_out], recv2, recv3, recv1_std[0::inv_out], 1, 1)
plot_line(figure_name, recv_inst1[0::inv_out], recv2, recv2, 1)

figure_name = 'figure/std_inst_'+prefix +str(1)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(0.8)+ebuse_str+str(0.2)+'.jpg'
#plot_error(figure_name, time_data[0::inv_out], recv_inst2[0::inv_out], recv2, recv3, recv2_std[0::inv_out], 1, 1)
plot_line(figure_name, recv_inst2[0::inv_out], recv2, recv2, 1)

figure_name = 'figure/std_inst_'+prefix +str(2)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(0.8)+ebuse_str+str(0.2)+'.jpg'
#plot_error(figure_name, time_data[0::inv_out], recv_inst3[0::inv_out], recv2, recv3, recv3_std[0::inv_out], 1, 1)
plot_line(figure_name, recv_inst3[0::inv_out], recv2, recv2, 1)
