...
for ti in range(0,10):
	...
	for i in range(0,dim):
		...
		prefix2 = 'true_/outfile0_threshold_'
		prefix3 = 'filter_true/outfile0_threshold_'
		prefix4 = 'noise_random_true/outfile0_threshold_'
		...
		file_name = prefix4+threshold_rate_str+'_type_'+str(item_type)+infile_name+'_true_table'+postfix
