...
threshold_rate_vector = [80, 100, 120, 140, 160]

for ti in range(0,5):
	threshold_rate=threshold_rate_vector[ti]
	threshold_rate_str = str(threshold_rate)#"0.0005"

	summary_file_name = "summary_average_false_rate_bytes.csv"
		
	addToFile(summary_file_name, threshold_rate_str+"\n")

	for i in range(0,dim):
		prefix1 = 'flow_true_hh/outfile0_threshold_'
		prefix2 = 'flow_table_hh/outfile0_threshold_'
		prefix3 = 'flow_filter_hh/outfile0_threshold_'
		#prefix4 = 'noise_filter/outfile0_threshold_'
		
		infile_name='_mapped-flow-out_filter_300'
		infile_name_true='_mapped-flow-out_table_300' 
