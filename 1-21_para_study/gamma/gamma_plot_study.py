...
for i in range(0,dim):
	...
	ebuse_str='_e'
	postfix='.csv'
	file_name = prefix+str(0)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+postfix
	recv1, recv2 = read_csv_data(file_name, 23, 25)
	file_name = prefix+str(1)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+postfix
...
figure_name = 'figure/std_'+prefix +str(0)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::100], recv1_avg[0::100], recv2, recv3, recv1_std[0::100], 1, 1)

figure_name = 'figure/std_'+prefix +str(1)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::100], recv2_avg[0::100], recv2, recv3, recv2_std[0::100], 1, 1)


figure_name = 'figure/std_'+prefix +str(2)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
...
for i in range(0,dim):
	...
	file_name = file_name = prefix+str(0)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+postfix
	recv1, recv2 = read_csv_data(file_name, 0,1)
	file_name = file_name = prefix+str(1)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+postfix
	recv3, recv4 = read_csv_data(file_name, 0,1)
	file_name = file_name = prefix+str(2)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+postfix
...
inv = 10;
figure_name = 'figure/std_res_'+prefix +str(0)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv], recv1_avg[0::inv], recv2, recv3, recv1_std[0::inv], 1, 2)

figure_name = 'figure/std_res_'+prefix +str(1)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv], recv2_avg[0::inv], recv2, recv3, recv2_std[0::inv], 1, 2)

figure_name = 'figure/std_res_'+prefix +str(2)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv], recv3_avg[0::inv], recv2, recv3, recv3_std[0::inv], 1, 2)

figure_name = 'figure/std_res_'+prefix +str(3)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv], recv4_avg[0::inv], recv2, recv3, recv4_std[0::inv], 1, 2)

figure_name = 'figure/std_res_'+prefix +str(4)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv], recv5_avg[0::inv], recv2, recv3, recv5_std[0::inv], 1, 2)

figure_name = 'figure/std_res_'+prefix +str(5)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv], recv6_avg[0::inv], recv2, recv3, recv6_std[0::inv], 1, 2)

figure_name = 'figure/std_res_t_'+prefix +str(0)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv], recv1_avg_t[0::inv], recv2, recv3, recv1_std_t[0::inv], 1, 2)

figure_name = 'figure/std_res_t_'+prefix +str(1)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
plot_error(figure_name, time_data[0::inv], recv2_avg_t[0::inv], recv2, recv3, recv2_std_t[0::inv], 1, 2)

figure_name = 'figure/std_res_t_'+prefix +str(2)+count_str+str(i)+alpha_str+str(alpha)+gamma_str+str(gamma)+ebuse_str+str(0.2)+'.jpg'
