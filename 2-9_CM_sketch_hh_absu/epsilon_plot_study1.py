...
threshold_rate_vector = [800000,	1600000,	2400000,	3200000,	8000000,	16000000, 24000000, 32000000]

for ti in range(0,threshold_dim):
	threshold_rate=threshold_rate_vector[ti]
	threshold_rate_str = str(threshold_rate)#"0.0005"

	summary_file_name = "summary_average_false_rate.csv"
	...
	for i in range(0,dim):
		...
		file_name = prefix1+threshold_rate_str+'_type_'+str(item_type)+infile_name_true+str(counter_num1)+'_table'+postfix
		ip_true, ip_true_freq = read_csv_data(file_name, 1, 5)
		file_name = prefix2+threshold_rate_str+'_type_'+str(item_type)+infile_name_true+str(counter_num2)+'_table'+postfix
		ip_table, ip_table_freq = read_csv_data(file_name, 1, 3)
		file_name = prefix3+threshold_rate_str+'_type_'+str(item_type)+infile_name+str(counter_num2)+'_table'+postfix
